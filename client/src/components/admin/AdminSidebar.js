...
const adminSidebar = () => {
    ...
    <div className="adminSidebar">
        ...
        <ul>
            ...
            <li><Link to={'/admin_dashboard/categories'}><img src={require('../../images/application.png')} alt="" width='15px' style={{marginRight: '8px'}}/> Categories</Link></li>
            ...
            <li><Link to={'/admin_dashboard/pending_orders'}><img src={require('../../images/cargo.png')} alt="" width='20px' style={{marginRight: '8px'}}/> Pending Orders</Link></li>
