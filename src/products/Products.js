...
const Products = () => {
   ...
   <br />
            <div className="topButton">
                ...
                <Link to="/admin_dashboard/add_products" style={{display:'flex', width:'15%',border: '1px solid maroon',marginLeft: '3%',textDecoration: 'none', backgroundColor: 'orange', color:'black', padding: '10px'}}>
