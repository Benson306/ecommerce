         ...
         <div>
            ...
            <div className='previews'>
                ...
                <div className="previewsInput">
                                ...
                                <br />
                                <br />
                                <img src={require(`../uploads/${product.preview1}`)} alt="" />
                </div>
                ...
                <div className="previewsInput">
                                ...
                                <br />
                                <br />
                                <img src={require(`../uploads/${product.preview2}`)} alt="" />
                </div>
                <div className="previewsInput">
                                <label htmlFor="">Preview Picture 3:</label>
                                <br />
                                <br />
                                <img src={require(`../uploads/${product.preview3}`)} alt="" />
                </div>
                <div className="previewsInput">
                                <label htmlFor="">Preview Picture 4:</label>
                                <br />
                                <br />
                                <img src={require(`../uploads/${product.preview4}`)} alt="" />
                </div>
            </div>
            <br />
            <br />
