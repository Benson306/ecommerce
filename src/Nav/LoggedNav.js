    ...
    return ( <div className='clientNav'>
        <nav>
            <ul>
                ...
                <li style={{display:'flex', justifyContent:'center', alignItems:'center'}}> <img src={require('../images/shopping-cart.png')} width="35%" style={{marginTop:'2%'}} alt="" /> <div style={{marginTop:'10px',marginLeft:'5%', paddingBottom:'5px'}}><Link to="/login" style={{color:'white', textDecoration:'none'}}>Cart</Link></div></li>
                ...
                <li style={{display:'flex', justifyContent:'center', alignItems:'center'}}> <img src={require('../images/user.png')} width="22%" style={{marginTop:'3%', objectFit:'scale-down'}} alt="" /> <div style={{marginTop:'10%',marginLeft:'2%', paddingBottom:'5px'}}><Link to="/login" style={{color:'white', textDecoration:'none'}}>Account</Link></div></li>
