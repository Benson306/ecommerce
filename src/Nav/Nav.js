    ...
    return ( <div className='clientNav'>
        <nav>
            <ul>
                ...
                <li style={{display:'flex', justifyContent:'center', alignItems:'center'}}> <img src={require('../images/user.png')} width="22%" style={{marginTop:'4%', objectFit:'scale-down'}} alt="" /> <div style={{marginTop:'10%',marginLeft:'2%', paddingBottom:'3px'}}><Link to="/login" style={{color:'white', textDecoration:'none'}}>Sign In</Link></div></li>
            </ul>
        </nav>
    </div> );
}
