    ...
    return ( <div className='clientNav'>
        <nav>
            <ul>
                ...
                <li style={{display:'flex', justifyContent:'center', alignItems:'center'}}> <img src={require('../images/user.png')} width="25%" style={{marginTop:'5%', objectFit:'scale-down'}} alt="" /> <div style={{marginTop:'10%',marginLeft:'2%', paddingBottom:'5px'}}><Link to="/login" style={{color:'white', textDecoration:'none'}}>Account</Link></div></li>
